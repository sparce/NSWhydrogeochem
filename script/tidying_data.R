...
Minex_S_Cobar<-Geochem1 %>%
  select(7:9,12,14,17,20:27) %>%                               # xtract columns of interest
  ...
  separate(WaterTable, c("depth_water_table","Obs_water_table"))                                                             # change fro scientific writing to regular numeric 
